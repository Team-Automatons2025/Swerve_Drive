...
public:
  Module(int index, int Rpwm, int Lpwm, Encoder& encoder, ODriveUART& odrive, long cpr) :
  ...
  void setVelocity(float velocity) {
    odrive.SetVelocity(0, velocity * direction);
  }

  void moveToPosition(float position) {
    odrive.SetPosition(0, position);
  }
};
